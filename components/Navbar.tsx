          ...
          <>
            ...
            <li className="flex items-center">
              <Link 
                ...
                className={`px-4 py-2 transition-all font-medium text-sm uppercase tracking-wide relative flex items-center ${
                  pathname.startsWith('/teacher/upload-material') ? 'bg-white/10' : ''
                } hover:bg-white/10`}
              >
                Upload Tài Liệu
                {pathname.startsWith('/teacher/upload-material') && <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-white"></span>}
              </Link>
            </li>
            <li className="flex items-center">
              <Link 
            ...
            <li className="flex items-center">
              <Link 
                href="/teacher/review" 
                className={`px-4 py-2 transition-all font-medium text-sm uppercase tracking-wide relative flex items-center ${
                  pathname.startsWith('/teacher/review') ? 'bg-white/10' : ''
                } hover:bg-white/10`}
              >
                Review Bài Thi
